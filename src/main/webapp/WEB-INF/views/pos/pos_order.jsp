	...
	<div style="float: left; width: 40%;">
		...
		<div>
			<table class="ex1">
				<thead>
					<tr>
						<th scope="col">상품<br>코드</th>
						<th scope="col">상품<br>이름</th>
						<th scope="col">수 량</th>
						<th scope="col">카테고리</th>
						<th scope="col">지 점</th>
						<th scope="col">신청<br>시간</th>
						<th scope="col">신청<br>삭제</th>
					</tr>
				</thead>
			...
			<form action="${pageContext.request.contextPath}/pos/ps_order_temp"
				method="post">
				<input style="float: right; margin-right: 30px;" width="40" type="image" src="/controller/resources/images/check.png" alt="submit">
			</form>
		</div>
	</div>
