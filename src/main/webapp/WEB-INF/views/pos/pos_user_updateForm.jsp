	...
	<form action="${pageContext.request.contextPath}/pos/ps_user_update"
		...
		<c:forEach items="${ list }" var="list">
			<table id="table_insert">
				...
				<input type="text" id="postcode" placeholder="우편번호" name="postcode" value="postcode">
				<input type="button" onclick="execDaumPostcode()" value="우편번호 찾기"><br>
				<input type="text" id="address" placeholder="주소" name="address" value="address">
				<input type="text" id="address2" placeholder="상세주소" name="address2" value="address2">
