...
<div class="w3-container">
  <ul class="w3-navbar w3-card-2 w3-white w3-center">
    ...
    <li style="width:20%"><a href="${pageContext.request.contextPath}/pos/ps_calcform?id=${LoingUser}">계  산</a></li>
  	</sec:authorize>
  	<sec:authorize access="hasAnyAuthority('ROLE_MANAGER', 'ROLE_USER')">
  	<li style="width:20%"><a href="${pageContext.request.contextPath}/pos/ps_notice_list">공 지 사 항</a></li>
  	</sec:authorize>
  </ul>
</div>
