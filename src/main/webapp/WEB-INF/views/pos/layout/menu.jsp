...
<div class="w3-container">
	<ul class="w3-navbar w3-card-2 w3-center"
		...
		<li></li>
		<li style="width: 25%" class="w3-dropdown-hover"><a href="#">재고
		...
		<li style="width: 25%" class="w3-dropdown-hover"><a href="#">매출
				관리 <i class="fa fa-caret-down"></i>
		</a>
			<div style="width: 334px;"
				class="w3-dropdown-content w3-light-gray w3-card-4">
		...
		<li style="width: 25%" class="w3-dropdown-hover"><a href="#">출
